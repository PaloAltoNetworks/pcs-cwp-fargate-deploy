...
- **DOCKER_USER (optional):** Username to access the private docker registry. Not required if the images are from Public ECR, Private ECR or Public DockerHub.
- **DOCKER_PASS (optional):** Password to access the private docker registry. Not required if the images are from Public ECR, Private ECR or Public DockerHub.
...
- **prismaapi.py**: File used to make http request to Prisma Cloud
...
| DOCKER_USER     | Username to access the private docker registry                                                                               | -                   | No                                        |
| DOCKER_PASS     | Password access the private docker registry                                                                                  | -                   | No                                        |
